...
Uses the capacity and the closeness centrality metric to set weights along the links.
"""
class ClosenessCapacity(GenericSR):
    ...
    def solve(self) -> dict:
        """ set weights to capacity divided by weighted closeness centrality and use shortest path algorithm """
