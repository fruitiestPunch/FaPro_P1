...
from algorithm.segment_routing.inverse_capacity import InverseCapacity
from algorithm.segment_routing.sequential_combination_2 import SequentialCombination_2
...
def get_algorithm(algorithm_name: str, nodes: list, links: list, demands: list, weights=None, waypoints=None,
    ...
    if algorithm_name == "demand_first_waypoints":
        ...
        algorithm = SequentialCombination(nodes, links, demands, weights, waypoints, seed=seed, time_out=time_out,
                                          first_algorithm="heur_ospf_weights",
                                          second_algorithm="demand_first_waypoints")
    elif algorithm_name == "sequential_combination_2":
        algorithm = SequentialCombination_2(nodes, links, demands, weights, waypoints, seed=seed, time_out=time_out,
                                           first_algorithm="heur_ospf_weights",
                                           second_algorithm="uniform_weights")
