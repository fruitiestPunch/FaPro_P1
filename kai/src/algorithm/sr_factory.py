...
from algorithm.segment_routing.eigenvector_inverse_capacity import EigenvectorInverseCapacity
from algorithm.segment_routing.betweeness_inverse_capacity import BetweenessInverseCapacity
from algorithm.segment_routing.eigenvector_capacity import EigenvectorCapacity
from algorithm.segment_routing.betweeness_capacity import BetweenessCapacity
from algorithm.segment_routing.betweeness_routing import BetweenessRoute
from algorithm.segment_routing.closeness_inverse_capacity import ClosenessInverseCapacity
from algorithm.segment_routing.closeness_capacity import ClosenessCapacity
...
def get_algorithm(algorithm_name: str, nodes: list, links: list, demands: list, weights=None, waypoints=None,
    ...
    elif algorithm_name == "eigenvector_inverse_capacity":
        algorithm = EigenvectorInverseCapacity(nodes, links, demands, weights, waypoints, seed=seed)
    elif algorithm_name == "betweeness_inverse_capacity":
        algorithm = BetweenessInverseCapacity(nodes, links, demands, weights, waypoints, seed=seed)
    elif algorithm_name == "eigenvector_capacity":
        algorithm = EigenvectorCapacity(nodes, links, demands, weights, waypoints, seed=seed)
    elif algorithm_name == "betweeness_capacity":
        algorithm = BetweenessCapacity(nodes, links, demands, weights, waypoints, seed=seed)
    elif algorithm_name == "betweeness_routing":
        algorithm = BetweenessRoute(nodes, links, demands, weights, waypoints, seed=seed)  
    elif algorithm_name == "closeness_capacity":
        algorithm = ClosenessCapacity(nodes, links, demands, weights, waypoints, seed=seed)
    elif algorithm_name == "closeness_inverse_capacity":
        algorithm = ClosenessInverseCapacity(nodes, links, demands, weights, waypoints, seed=seed)
    else:
