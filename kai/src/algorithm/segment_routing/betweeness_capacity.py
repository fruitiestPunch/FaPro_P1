...
Uses the capacity and the betweeness centrality metric to set weights along the links.
"""
class BetweenessCapacity(GenericSR):
    ...
    def solve(self) -> dict:
        """ set weights to capacity divided by weighted betweeness centrality and use shortest path algorithm """
