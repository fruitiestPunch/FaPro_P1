...
Uses the inverse capacity and the eigenvector centrality metric to set weights along the links.
"""
class EigenvectorInverseCapacity(GenericSR):
    ...
    def solve(self) -> dict:
        """ set weights to inverse capacity divided by weighted eigenvector centrality and use shortest path algorithm """
    ...
    def get_name(self):
        ...
        return f"eigenvector_inverse_capacity"
