...
algo_c_map = {
    ...
    #'JointHeur': "seagreen",
    #'ILP Joint': "darkgreen",
    'EigenvectorCapacity': "violet",
    'EigenvectorInverseCapacity': "purple",
    'BetweenessCapacity': "firebrick",
    'BetweenessInverseCapacity': "maroon",
    'ClosenessCapacity': "darkcyan",
    'ClosenessInverseCapacity': "cyan",
}
